...
export function LandingPage() {
  ...
  return (
    <section className="mx-auto grid min-h-[calc(100dvh-8rem)] max-w-7xl items-center gap-10 px-4 py-10 lg:grid-cols-[1.1fr_0.9fr]">
      <div>
        <p className="font-mono text-sm tracking-[0.28em] text-accent">{t('landing.kicker')}</p>
        <h1 className="mt-4 max-w-xl text-5xl font-semibold leading-[1.05] md:text-7xl">
          {t('landing.title')}
        </h1>
        <p className="mt-6 text-2xl text-ink md:text-3xl">{t('landing.tagline')}</p>
        <p className="mt-4 max-w-[36ch] text-lg text-mute">{t('landing.body')}</p>
      ...
      <div className="rounded-[16px] border border-line bg-surface p-6 md:p-8">
        <p className="font-mono text-xs tracking-[0.2em] text-mute">{t('landing.how')}</p>
        <ol className="mt-6 grid gap-5 text-lg">
          <li>
            <span className="font-mono text-accent">01</span> {t('landing.step1')}
          </li>
          <li>
            <span className="font-mono text-accent">02</span> {t('landing.step2')}
          </li>
          <li>
            <span className="font-mono text-accent">03</span> {t('landing.step3')}
          </li>
          <li>
            <span className="font-mono text-accent">04</span> {t('landing.step4')}
          </li>
          <li>
            <span className="font-mono text-accent">05</span> {t('landing.step5')}
          </li>
        </ol>
